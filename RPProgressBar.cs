...
namespace RPElite
{
    class RPProgressBar : Control
    {
        public enum RPProgressTextType
        {
            AsIs, Percent
        }
        ...
        public RPProgressTextType ProgressTextType { get; set; }

        public RPProgressBar()
        {
            ...
            this.ProgressTextType = RPProgressTextType.AsIs;
        }
        ...
        protected void FsProgressBar_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (this.ShowProgressText)
            {
                ...
                {
                    case RPProgressTextType.AsIs:
                        text = this.Value + " / " + this.MaxValue;
                        break;
                    case RPProgressTextType.Percent:
